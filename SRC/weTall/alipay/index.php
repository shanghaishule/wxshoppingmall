...
：</dt>
	...
	支付宝：<input name="optEmail" type="text" value="yansapjxe@sohu.com" /><br></br>
	order：<input name="title" type="text" value="order_2013090811111" /><br></br>
	金额：<input name="payAmount" type="text" value="0.01" /><br></br>
	<input name="ok" type="submit" value="支付" />
	</form>
</body>
</html>