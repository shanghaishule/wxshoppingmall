...
/**************************请求参数**************************/
        ...
        $notify_url = "http://".$_SERVER['SERVER_NAME']."/alipay/notify_url.php";
        //需http://格式的完整路径，不能加?id=123这类自定义参数

        //页面跳转同步通知页面路径
        //$return_url = "http://www.xxx.com/create_partner_trade_by_buyer-PHP-UTF-8/return_url.php";
        $return_url = "http://".$_SERVER['SERVER_NAME']."/alipay/return_url.php";
