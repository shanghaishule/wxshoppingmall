(function($)
{
    ...
    $.fn.InitValidate = function(cfg)
    {
        ...
        return this.each(function()
        {
            ...
            var tip = $("#" + this.id + "Tip").html(idl.tipText);
            var tippar = tip.parent().addClass("tipText")
                        .removeClass("tipSucc")
                        .removeClass("tipWait")
                        .removeClass("tipErr");
            $(this)
                ...
                .focus(function()
                {
                    tip.html(idl.tipText);
                    tippar.addClass("tipText")
                        .removeClass("tipSucc")
                        .removeClass("tipWait")
                        .removeClass("tipErr");
                    ;
